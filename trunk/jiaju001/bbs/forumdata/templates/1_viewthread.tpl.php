...
<div id="foruminfo">
	<div id="nav">
		<? if($forumjump && $jsmenu['1']) { ?><a href="<?=$indexname?>" id="forumlist" onmouseover="showMenu(this.id)" class="dropmenu"><?=$bbname?></a><? } else { ?><a href="<?=$indexname?><? if($areaid==2) { ?>?areaid=2<? } ?>"><?=$bbname?></a><? } ?> <?=$navigation?>
	</div>
	<div id="headsearch">
