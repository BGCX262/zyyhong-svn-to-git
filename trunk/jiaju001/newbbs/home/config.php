...
$_SC['dbuser']  		= 'root'; //用户
$_SC['dbpw'] 	 		= 'lic77158906'; //密码
$_SC['dbcharset'] 		= 'utf8'; //字符集
$_SC['pconnect'] 		= 0; //是否持续连接
$_SC['dbname']  		= 'newclub'; //数据库
...
define('UC_DBPW', 'lic77158906'); // UCenter 数据库密码
define('UC_DBNAME', 'newclub'); // UCenter 数据库名称
define('UC_DBCHARSET', 'utf8'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`newclub`.uc_'); // UCenter 数据库表前缀
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', '17Ye90D7MdLeh7n0g5Z1p4ac94M3adLfE927z2YfqasbB4P0F7TepeicM3I2bdzb'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://localhost/newbbs/ucenter'); // UCenter 的 URL 地址, 在调用头像时依赖此常量
