...
// [CH] 论坛安全设置, 调整以下设置，可以增强论坛的安全性能和防御性能
	...
	$adminemail = 'faithsmine@gmail.com';		// 系统管理员 Email
...
define('UC_DBPW', 'lic77158906');
define('UC_DBNAME', 'newclub');
define('UC_DBCHARSET', 'utf8');
define('UC_DBTABLEPRE', '`newclub`.uc_');
define('UC_DBCONNECT', '0');
define('UC_KEY', 'd4o42ch8a69c07cb1cy680F227Ddu5D8PcI7ydj54fC9u2m2ifRcV3y4Y0ndJ8Ae');
define('UC_API', 'http://localhost/newbbs/ucenter');
