...
|| checktplrefresh('D:\Website\51shangcheng.cn\htdocs\././templates/default/showmessage.htm', 'D:\Website\51shangcheng.cn\htdocs\././templates/default/footer.htm', 1250675114, '1', './templates/default')
|| checktplrefresh('D:\Website\51shangcheng.cn\htdocs\././templates/default/showmessage.htm', 'D:\Website\51shangcheng.cn\htdocs\././templates/default/css_script.htm', 1250675114, '1', './templates/default')
|| checktplrefresh('D:\Website\51shangcheng.cn\htdocs\././templates/default/showmessage.htm', 'D:\Website\51shangcheng.cn\htdocs\././templates/default/jsmenu.htm', 1250675114, '1', './templates/default')
;?>
...
<? } else { include template('header_ajax'); } if(!$inajax) { ?>
...
<p><a href="<?=$url_forward?>">如果您的浏览器没有自动跳转，请点击此链接</a></p>
<? } else { ?>
<p><a href="<?=$url_forward?>">如果 <?=$refreshtime?> 秒后下载仍未开始，请点击此链接</a></p>
...
<div>
<h3 class="float_ctrl"><em><?=$bbname提示信息?></em><span><a href="javascript:;" class="float_close" onclick="clearTimeout(nopermst);floatwinreset = 1;floatwin('close_<?=$handlekey?>');" title="关闭">关闭</a></span></h3>
...
<? } else { ?>
<button onclick="floatwinreset = 1;floatwin('close_<?=$handlekey?>');">关闭</button>
<? } ?>			
</div>
</div>
<? } else { echo str_replace(array("，请返回", "，请。"), array("，请", "。"), $show_message); if($extra == 'HALTED' || $extra == 'NOPERM' || $extra == 'AJAXERROR') { ?><script type="text/javascript" reload="1">
function ajaxerror() {
alert('<?=$show_message?>');
}
...
</html><? } else { include template('footer_ajax'); } ?>