...
|| checktplrefresh('D:\Website\51shangcheng.cn\htdocs\././templates/default/my.htm', 'D:\Website\51shangcheng.cn\htdocs\././templates/default/personal_navbar.htm', 1250676277, '1', './templates/default')
|| checktplrefresh('D:\Website\51shangcheng.cn\htdocs\././templates/default/my.htm', 'D:\Website\51shangcheng.cn\htdocs\././templates/default/footer.htm', 1250676277, '1', './templates/default')
|| checktplrefresh('D:\Website\51shangcheng.cn\htdocs\././templates/default/my.htm', 'D:\Website\51shangcheng.cn\htdocs\././templates/default/css_script.htm', 1250676277, '1', './templates/default')
|| checktplrefresh('D:\Website\51shangcheng.cn\htdocs\././templates/default/my.htm', 'D:\Website\51shangcheng.cn\htdocs\././templates/default/jsmenu.htm', 1250676277, '1', './templates/default')
;?>
...
<? if($srchfid) { ?><a href="my.php?item=<?=$item?><?=$extra?>"><? } if(empty($item) || in_array($item, array('threads', 'posts', 'polls', 'tradestats', 'selltrades', 'buytrades', 'tradethreads', 'reward', 'activities', 'debate', 'video'))) { ?>我的帖子
<? } elseif($item == 'favorites') { ?>我的收藏
<? } elseif($item == 'subscriptions') { ?>我的订阅
...
<? if(empty($item) || in_array($item, array('threads', 'posts', 'polls', 'tradestats', 'selltrades', 'buytrades', 'tradethreads', 'reward', 'activities', 'debate', 'video'))) { ?>
<h1>我的帖子</h1>
<ul>
...
<li class="pipe">|</li>
<li id="polls" onmouseover="showMenu(this.id)"<? if($item == 'polls') { ?> class="current"<? } ?>><a href="my.php?item=polls&amp;type=poll<?=$extrafid?>" hidefocus="true" class="dropmenu"><span>投票</span></a></li>
<li id="rewards" onmouseover="showMenu(this.id)"<? if($item == 'reward') { ?> class="current"<? } ?>><a href="my.php?item=reward&amp;type=stats<?=$extrafid?>" hidefocus="true" class="dropmenu"><span>悬赏</span></a></li>
<li id="activities" onmouseover="showMenu(this.id)"<? if($item == 'activities') { ?> class="current"<? } ?>><a href="my.php?item=activities&amp;type=orig<?=$extrafid?>" hidefocus="true" class="dropmenu"><span>活动</span></a></li>
<li id="debates" onmouseover="showMenu(this.id)"<? if($item == 'debate') { ?> class="current"<? } ?>><a href="my.php?item=debate&amp;type=orig<?=$extrafid?>" hidefocus="true" class="dropmenu"><span>辩论</span></a></li>
<? if($videoopen || $tradeopen) { ?><li class="pipe">|</li><? } if($videoopen) { ?><li<? if($item == 'video') { ?> class="current"<? } ?>><a href="my.php?item=video&amp;type=orig<?=$extrafid?>" hidefocus="true"><span>视频</span></a></li><? } if($tradeopen) { ?><li id="trades" onmouseover="showMenu(this.id)"<? if(in_array($item, array('tradestats', 'selltrades', 'buytrades', 'tradethreads'))) { ?> class="current"<? } ?>><a href="my.php?item=tradestats<?=$extrafid?>" hidefocus="true" class="dropmenu"><span>商品</span></a></li><? } ?>
</ul>
<? } elseif($item == 'favorites') { ?>
<h1>我的收藏</h1>
<ul>
<li<? if($type == 'thread') { ?> class="current"<? } ?>><a href="my.php?item=favorites&amp;type=thread<?=$extrafid?>"><span>收藏的主题</span></a></li>
<li<? if($type == 'forum') { ?> class="current"<? } ?>><a href="my.php?item=favorites&amp;type=forum<?=$extrafid?>"><span>收藏的版块</span></a></li>
</ul>
...
<? if(empty($item) || $item == 'threads') { include template('my_threads'); } elseif($item == 'posts') { include template('my_posts'); } elseif($item == 'polls') { include template('my_polls'); } elseif(in_array($item, array('tradestats', 'selltrades', 'buytrades', 'tradethreads'))) { if($item == 'tradestats') { include template('my_tradestats'); } elseif($item == 'selltrades' || $item == 'buytrades') { include template('my_trades'); } elseif($item == 'tradethreads') { include template('my_tradethreads'); } } elseif($item == 'reward') { include template('my_rewards'); } elseif($item == 'activities') { include template('my_activities'); } elseif($item == 'debate') { include template('my_debate'); } elseif($item == 'video') { include template('my_video'); } elseif($item == 'favorites') { include template('my_favorites'); } elseif($item == 'subscriptions') { include template('my_subscriptions'); } elseif($item == 'buddylist') { include template('my_buddylist'); } ?>
</div>
<ul class="popupmenu_popup titlemenu_popup" id="polls_menu" style="display: none">
<li <? if($type == 'poll') { ?> class="current"<? } ?>><a href="my.php?item=polls&amp;type=poll<?=$extrafid?>">我发起的</a></li>
<li <? if($type == 'join') { ?> class="current"<? } ?>><a href="my.php?item=polls&amp;type=join<?=$extrafid?>">我参与的</a></li>
</ul>
